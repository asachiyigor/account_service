...
INSERT INTO account (account_number, user_id, type, currency, status)
...
INSERT INTO account (account_number, project_id, type, currency, status)
...
(
    ...
    CONSTRAINT pk_free_account_number PRIMARY KEY (account_type, account_number)
    );
